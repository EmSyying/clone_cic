        ...
        routes: [
          ...
          GoRoute(
            ...
            builder: (context, state) {
              return ViewWebsite(
                ...
                isfromReport:
                    state.queryParams['isfromReport']!.toLowerCase() == 'true',
                key: state.pageKey,
                title: state.queryParams['title'],
              );
            },
                ...
                GoRoute(
                    ...
                    builder: (context, state) {
                      ...
                      return BulletPaymentDetail(
                          ...
                          isNoUSD: param['isNoUSD'].toString().toLowerCase() ==
                              'true',
          ...
          GoRoute(
            ...
            builder: (context, state) {
              ...
              return BulletPaymentDetail(
                  isAnnullyRate:
                      param['isAnnullyRate'].toString().toLowerCase() == 'true',
                  titles: param['titles'].toString(),
                  isNoUSD: param['isNoUSD'].toString().toLowerCase() == 'true',
                  status: param['status'].toString(),
                  id: param['id'] as num,
                  isStatusPending:
