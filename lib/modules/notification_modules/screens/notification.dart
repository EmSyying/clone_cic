                                                                                    ...
                                                                                    : _con.notificationList[index].data!.status!.toLowerCase() == 'canceled'
                                                                                        ...
                                                                                        : _con.notificationList[index].data!.type == 'Equity' && _con.notificationList[index].presentType == "Other"
                                                                                            ...
                                                                                            : _con.notificationList[index].data!.type == 'Debt' && _con.notificationList[index].presentType == "Other"
                                                                                                ...
                                                                                                : _con.notificationList[index].data!.type == 'wallet-cashout' || _con.notificationList[index].data!.type == 'wallet-deposit' || _con.notificationList[index].data!.type == 'cash-out' || _con.notificationList[index].data!.type == 'confirm-subscription' || _con.notificationList[index].data!.type == 'confirm-payment' || _con.notificationList[index].data!.type == 'receiver' || _con.notificationList[index].data!.type == 'transferer' || _con.notificationList[index].data!.type == 'bonus' || _con.notificationList[index].data!.type == 'exchange'
                                                                                                    ? () async {
