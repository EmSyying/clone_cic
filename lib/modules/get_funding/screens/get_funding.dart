      ...
      children: [
                        ...
                        child: Showcase(
                          onToolTipClick: () {
                            LocalStorage.storeData(
                                key: 'ISFIRST_GET_FUNDING', value: true);
                          },
                          onTargetClick: () {
                            debugPrint('end');
                          },
        ...
        Container(
          ...
          child: TabBar(
            onTap: (i) {
              if (i == 0) {
                ...
                setState(() {
                  ...
                  FirebaseAnalyticsHelper.sendAnalyticsEvent("Debt Investment");
                });
              }
            },
            ...
            unselectedLabelColor: Get.theme.brightness == Brightness.light
                ? Colors.grey[500]
                : Colors.white,
            tabs: const [
              Tab(
