...
class PersonalProfile with _$PersonalProfile {
  factory PersonalProfile({
    ...
    @JsonKey(name: 'customer_latin_name') final String? customerLatinName,
    @JsonKey(name: 'customer_date_of_birth') final String? customerDateOfBirth,
    @JsonKey(name: 'customer_gender') final CustomerGender? customerGender,
    ...
    @JsonKey(name: 'customer_identity_date') final String? customerIdentityDate,
