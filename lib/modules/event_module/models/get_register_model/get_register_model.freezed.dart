...
GetRegisterModel _$GetRegisterModelFromJson(Map<String, dynamic> json) {
  return _GetRegisterModel.fromJson(json);
}

/// @nodoc
mixin _$GetRegisterModel {
  ...
  @JsonKey(ignore: true)
  $GetRegisterModelCopyWith<GetRegisterModel> get copyWith =>
...
/// @nodoc
abstract class _$$_GetRegisterModelCopyWith<$Res>
    implements $GetRegisterModelCopyWith<$Res> {
  factory _$$_GetRegisterModelCopyWith(
...
/// @nodoc
@JsonSerializable()
class _$_GetRegisterModel implements _GetRegisterModel {
  _$_GetRegisterModel(
      {this.id,
      this.name,
      this.event,
