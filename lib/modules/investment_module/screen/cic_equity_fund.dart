                                                                    ...
                                                                    Obx(
                                                                      () => priceController.price.value.price !=
                                                                          ...
                                                                          ? Text(
                                                                              ...
                                                                              style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 22, fontFamily: 'DMSans', color: Colors.black),
                                                                            )
                                                                          : Container(),
                                                                    ),
                                                                  ],
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            ...
                                                                            style: Get.theme.brightness == Brightness.light
                                                                                ? TextStyle(color: Colors.grey[500], fontFamily: 'DMSans')
                                                                                : const TextStyle(color: Colors.white, fontFamily: 'DMSans'),
                                                                          ),
                                                                          Obx(
                                                                            () =>
                                                                                Text(
                                                                              priceController.sharePrice.value.totalShareOutstanding != null && priceController.sharePrice.value.totalShareOutstanding != 0 ? n.format(priceController.sharePrice.value.totalShareOutstanding) : '0.0',
                                                                      ...
                                                                      Column(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Obx(
                                                                            () =>
                                                                                Text(
                                                                              priceController.sharePrice.value.totalNetWorth != null && priceController.sharePrice.value.totalNetWorth != 0 ? '\$${f.format(priceController.sharePrice.value.totalNetWorth)}' : '\$0.0',
                                                                              style: Theme.of(context).textTheme.headline3,
                                                                            ),
                                                                          ),
                                                                        ],
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              Text(
                                                                                'UT Price Evolution',
                                                                                key: _guidkey.investmentKey[3].key = GlobalKey(),
                                                                                style: Get.theme.brightness == Brightness.light ? TextStyle(color: Colors.grey[500], fontFamily: 'DMSans') : const TextStyle(color: Colors.white, fontFamily: 'DMSans'),
                                                                              ),
                                                                              Text(
                                                                                'Figure in USD',
                                                                    ...
                                                                    () => priceController
                                                                        ...
                                                                        : priceController.sharePrice.value.evolution !=
                                                                            ...
                                                                            ? Positioned(
                                                                                ...
                                                                                right: 5,
                                                                                bottom: 0,
                                                                                child: CiCLineChart(dataList: priceController.sharePrice.value.evolution!.reversed.toList()),
                                                                              )
                                                                            : Positioned(
                                                                                top: 50,
                                                                                left: 5,
                                                                                right: 5,
                                                                                bottom: 0,
                                                                                child: CiCLineChart(dataList: reversList),
                                                                              ),
                                                                  ),
                                                                ],
                                                              ),
