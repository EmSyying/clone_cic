...
import 'package:cicgreenloan/modules/ut_trading/screens/add_inquiry.dart';
...
class MatchTrade extends StatefulWidget {
  const MatchTrade({Key? key}) : super(key: key);

  @override
  State<MatchTrade> createState() => _MatchTradeState();
}

class _MatchTradeState extends State<MatchTrade> {
  ...
  void onCreateInquiryPage() async {
    value = (await Navigator.push<String>(
        context, MaterialPageRoute(builder: (context) => const AddInquiry())))!;
    if (value == "yes") {}
  }
  ...
  Widget build(BuildContext context) {
    return Obx(
      () => !inquiryController.isLoadingInquiryMatch.value &&
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        if (inquiryController.listinquiryData.isNotEmpty)
                          CustomBuyCard(
                            listData: inquiryController.listinquiryData.reversed
                                .toList(),
                          ),
                      ],
                    ),
