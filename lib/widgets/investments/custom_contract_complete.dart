...
class CustomContractComplete extends StatelessWidget {
  const CustomContractComplete({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final fifController = Get.put(PriceController());
    fifController.fectContractHistory(contractType: 'completed');
    return Obx(
