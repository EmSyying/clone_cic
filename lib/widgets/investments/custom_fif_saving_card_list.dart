                ...
                return Column(
                  ...
                  return FIFSavingCard(
                      ...
                      fifController.onViewAgreement(e.value.id!.toInt()).then(
                        (value) {
                          value.isNotEmpty && value.length == 1
                              ? context.push(
                                  '/investment/fixed-income-fund/view-agreement?title=${value[0].title ?? ''}&title=${value[0].url}',
                                )
                              : context.push(
                                  '/investment/fixed-income-fund/view-agreement-list',
                                  extra: value);
                        },
                      );
                    ...
                    onTapCard: () async {
                      ...
                      context.push(
                          '/investment/fixed-income-fund/saving-detail',
                          extra: {
                  ...
                  children: fifConfirmList!.asMap().entries.map((e) {
                    return FIFSavingCard(
                      ...
                      onTapCard: () async {
                        ...
                        context.push(
                            '/investment/fixed-income-fund/deposite-screen/${e.value.id!.toInt()}');
                      },
                    );
                  }).toList(),
                ),
                      ...
                      .map(
                        (e) => FIFSavingCard(
                          ...
                          onTapEdit: () async {
                            ...
                            Navigator.pop(context);
                            context.push(
                                '/investment/fixed-income-fund/edit-application/${e.value.id}');
                          },
                          pendingStyle: true,
                          ...
                          onTapCard: () async {
                            ...
                            context.push(
                                '/investment/fixed-income-fund/bullet-payment-detail',
                                extra: {
                                  "isAnnullyRate": true,
